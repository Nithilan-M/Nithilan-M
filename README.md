...
[![Portfolio](https://img.shields.io/badge/🌐_Portfolio-nithilan.tech-0d1117?style=for-the-badge&labelColor=0d1117&color=00d4ff)](https://nithilan.tech)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-nithilanm-0d1117?style=for-the-badge&logo=linkedin&logoColor=00d4ff&labelColor=0d1117&color=00d4ff)](https://linkedin.com/in/nithilanm)
[![Email](https://img.shields.io/badge/Email-nithil9320@gmail.com-0d1117?style=for-the-badge&logo=gmail&logoColor=00d4ff&labelColor=0d1117&color=00d4ff)](mailto:nithil9320@gmail.com)
...
### 🔄 ETL Middleware & Data API Platform
> *Production-grade data integration engine*

A backend-first ETL middleware built for resilient, real-time data flows.

- ⚡ **Async processing** via Redis + Dead Letter Queue
- 🔁 **Retry handling** with fault-tolerant pipeline scheduling
- 🔐 **Secure auth** — Bearer token & OAuth2
- 📦 **Dynamic transformations** with APScheduler

`Python` `Flask` `MySQL` `Redis` `APScheduler` `React`
...
- 🏥 **Concurrent workflows** with PostgreSQL (Supabase)
- 🔒 **Secure auth** + automated booking logic
- 🌐 **RESTful APIs** for all scheduling operations
- ✅ Optimized for scale and consistency

`Python` `Flask` `PostgreSQL` `Supabase` `JavaScript`
...
*"Data is only as good as the pipeline that delivers it."*

![Profile Views](https://komarev.com/ghpvc/?username=Nithilan-M&color=00d4ff&style=flat-square&label=Profile+Views)
